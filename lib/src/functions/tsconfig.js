...
module.exports = async projectName => {
  ...
  "compilerOptions": {
    ...
    "target": "ES2020"                        /* Specify ECMAScript target version: 'ES3' (default), 'ES5', 'ES2015', 'ES2016', 'ES2017', 'ES2018', 'ES2019', 'ES2020', 'ES2022', or 'ESNEXT'. */,
...
`,
  ...
  await Promise.all([
    writeFile(`${projectName}/${data.base.file}`, data.base.content),
    writeFile(`${projectName}/${data.prod.file}`, data.prod.content)
  ])
}
